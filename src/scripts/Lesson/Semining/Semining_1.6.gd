...
@export var header_text: String = "POINTS TO REMEMBER!"
@export var detail_one_text: String = "1. LOOPS- Ridge Counting "
@export var detail_two_text: String = "2. WHORL- Whorl Tracing
"
@export var detail_three_text: String = "If  Whorls appear in the thumb, the major reflects the whorl tracing just as the sub- secondary does. The symbols would be (I, O or M)"
@export var detail_four_text: String = "WHORLS:"
@export var detail_five_text: String = "INNER (I)- 3 or more ridges inside / above"
@export var detail_six_text: String = "MEETING (M)- One or two ridges either inside or outside"
@export var detail_seven_text: String = "OUTER (O)- 3 or more ridges outside or below"
