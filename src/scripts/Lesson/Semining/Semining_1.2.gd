...
@export var detail_one_text: String = "- it is the ridge count of the LOOPS or WHORLS in both little fingers expressed in numbers."
@export var detail_two_text: String = "- The right little finger is used as the numerator and theleft little finger as the denominator and both are placed at the extreme right of the classification line."
@export var detail_three_text: String = "- NO LOOP either left and right Little Fingers: Whorls are used base on Ridge Counting."
