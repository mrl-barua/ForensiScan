...
@export var detail_one_text: String = "Ridge Counting in Simple Whorls (W&C):"
@export var detail_two_text: String = "Whorl on the Right Little Finger: Counting from Left delta to core"
@export var detail_three_text: String = "Whorl on the Left Little Finger: Counting from Right delta to core"
