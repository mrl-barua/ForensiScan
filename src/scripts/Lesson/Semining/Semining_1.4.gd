...
@export var detail_one_text: String = "Ridge Counting for Accidental Loop Whorl: Ridge counting from delta to core which has the least number of ridges."
@export var detail_two_text: String = "Both Loops and Whorl patterns are missing: No Final Classification"
