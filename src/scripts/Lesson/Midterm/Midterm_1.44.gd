...
@export var detail_one_text: String = "What kind of Loop Pattern this one, if this print comes from LEFT HAND."
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 44)
