...
@export var detail_one_text: String = "ACCIDENTAL Whorl- this term is given to a comparatively small group of nondescript patterns, which do not belong to traditional arch, loop or whorl types yet possess characteristics common to all three types. 
"
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 49)
