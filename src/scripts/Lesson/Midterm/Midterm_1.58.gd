...
@export var detail_one_text: String = "B. SMALL LETTER GROUP- This classification refers to the three types of fingerprint patterns only; namely plain arch, tented arch, radial loop. Whenever any or all of these patterns appear in any fingers, excluding the two Index fingers, its symbol in small letter is exhibited in classification line as: "
@export var detail_two_text: String = "a= plain arch "
@export var detail_three_text: String = "t= tented arch"
@export var detail_four_text: String = "r= radial loop "
@export var detail_five_text: String = "Before or after the Secondary Classification by capital letters depending on its origin."
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 58)
