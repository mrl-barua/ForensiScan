...
@export var header_text: String = "Fingerprint Outfit:"
@export var detail_one_text: String = "1. Finger Print Ink"
@export var detail_two_text: String = "2. Finger Print Roller"
@export var detail_three_text: String = "3. Finger Print Card"
@export var detail_four_text: String = "4. Finger Print Card Holder"
@export var detail_five_text: String = "5. Finger Print Liquid Cleaner"
@export var detail_six_text: String = "6. Finger Print Table"
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 12)
