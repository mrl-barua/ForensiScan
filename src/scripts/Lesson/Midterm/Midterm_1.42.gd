...
@export var header_text: String = "QUESTION?"
@export var detail_one_text: String = "What kind of Loop Pattern this one, if this print comes from RIGHT HAND."
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 42)
