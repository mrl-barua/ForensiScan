...
@export var detail_one_text: String = "18. Post-Mortem Fingerprinting Equipment- contains hypo dermic syringe, tissue builder solvent, tissue cleaner, etc."
@export var detail_two_text: String = "19. Carrying Case- a box like structure or an attache type may suffice."
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 23)
