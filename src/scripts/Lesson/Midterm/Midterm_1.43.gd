...
@export var detail_one_text: String = "Answer: RADIAL LOOP"
@export var detail_two_text: String = "because the slope down to the Right side. Also, the direction of the pattern is directing to the thumb."
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 43)
