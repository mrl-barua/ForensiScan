...
@export var detail_one_text: String = "4. Fingerprint Ink- this is a special manufactured ink for purposes of taking Finger Prints. 
"
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 16)
