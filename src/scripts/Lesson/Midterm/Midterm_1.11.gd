...
@export var detail_one_text: String = "With the application of science and technology in crime  detection  and with the demands of specialized training for furtherance of effective police work, many police departments have kept abreast with this modern techniques; for doing so, they began to set-up and operate crime laboratories. 
"
@export var detail_two_text: String = "Latent Print Examiners- these are specialized teams who are trained on crime-scene investigation .
"
@export var detail_three_text: String = "			- they are equipped with fingerprint kits."
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 11)
