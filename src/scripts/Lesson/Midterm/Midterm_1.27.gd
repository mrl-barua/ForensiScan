...
@export var detail_one_text: String = "Ridge Characteristics:"
@export var detail_two_text: String = "1. Bifurcation- the point where a ridge divides or folks to become two equally strong ridges to run either parallel or to diverge. It may point either a clock-wise or counter-clockwise."
@export var detail_three_text: String = "2. Island- a short ridge located within the temporary divergence of parallel ridges, running parallel to the ridge on either side."
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 27)
