...
@export var detail_one_text: String = "10. DIVERGENCE- the point where two ridges, which have been running together in parallel fashion, tend to separate and continue on another course."
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 31)
