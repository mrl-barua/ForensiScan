...
@export var header_text: String = "Solution and answer:"
@export var detail_one_text: String = "Erratum: The pattern in Left Index is Double Loop Whorl, as appeared in the example. Thus it will not affect the answer of your Primary Classification considering they are both Whorl patterns."
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 54)
