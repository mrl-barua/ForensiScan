...
@export var detail_one_text: String = "1. Ink Roller- one of the inking devices required for spreading the ink on the glass slab.
"
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 13)
