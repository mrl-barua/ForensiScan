...
@export var header_text: String = "ROLLED IMPRESSIONS"
@export var detail_one_text: String = "- are made by rolling the finger or thumb from nail edge to nail edge. They are made to show the entire friction surface of the finger or thumb, from the tip to one quarter inch below the first joint. The larger surface of the fully rolled impression not only allows accurate classification but it also gives more points for comparison."
@export var detail_two_text: String = "Right Fingers: 
"
@export var detail_three_text: String = "				> Thumb: Rolled from right to left direction"
@export var detail_four_text: String = "				> Remaining 4 fingers: Rolled from left to right direction"
@export var detail_five_text: String = "Left Fingers:"
@export var detail_six_text: String = "				> Thumb: Rolled from left to right direction"
@export var detail_seven_text: String = "				> Remaining 4 fingers: Rolled from right to left direction"
