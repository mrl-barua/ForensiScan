...
@export var header_text: String = "Primary classification"
@export var detail_one_text: String = "POINTS TO REMEMBER!"
@export var detail_two_text: String = "		1. The numerical Values (ZigZag Pattern)"
@export var detail_three_text: String = "		2. It Applies to WHORL pattern only"
@export var detail_four_text: String = "		3. the plus 1 for Denominator and Numerator"
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 51)
