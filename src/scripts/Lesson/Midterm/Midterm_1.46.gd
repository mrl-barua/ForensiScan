...
@export var header_text: String = "3. WHORL PATTERN"
@export var detail_one_text: String = "- Plain Whorl- at least on ridge makes a complete circuit of 360 degrees, giving an over all circular appearance"
@export var detail_two_text: String = "				-there are always 2 deltas which are located below to either side of the core and if an imaginary line is drawn between the deltas, it will touch or cross the circuiting ridge."
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 46)
