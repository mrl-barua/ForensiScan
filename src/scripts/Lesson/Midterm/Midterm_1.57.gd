...
@export var header_text: String = "A combination of the following symbols may come out: "
@export var detail_one_text: String = "Plain Arch- A				Tented Arch- T "
@export var detail_two_text: String = "Radial Loop- R 				Ulnar Loop- U "
@export var detail_three_text: String = "Plain Whorl- W				Central Pocket Loop Whorl- C"
@export var detail_four_text: String = "Double Loop Whorl- D 		Accidental Whorl- X"
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 57)
