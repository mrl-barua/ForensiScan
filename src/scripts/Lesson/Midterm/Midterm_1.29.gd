...
@export var detail_one_text: String = "6. Ridge Ending- the abrupt ending of a ridge that has previously continued for a quite distance.
"
@export var detail_two_text: String = "7. Broken Ridge- a ridge that appears to be continuous but upon close inspection proves to be broken up into segments."
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 29)
