...
@export var detail_one_text: String = "11. Flashlight- a very useful device for searching and for focusing on developed latent prints."
@export var detail_two_text: String = "12.Roller or Tape Measure- a roll type maybe carried for measuring a crime scene sketch."
@export var detail_three_text: String = "13. Pair of Forceps- for picking up objects."
@export var detail_four_text: String = "14. Graph Paper- for sketching purposes."
@export var detail_five_text: String = "15. Evidence-Identification Tapes or tags-used to identify  objects or physical evidence."
@export var detail_six_text: String = "16. Scissors- required for purposes of cutting latent print tapes."
@export var detail_seven_text: String = "17. Rubber Gloves- to protect the technicians fingers from leaving his own prints on the object."
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 22)
