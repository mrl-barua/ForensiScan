...
@export var detail_one_text: String = "DELTA- is that point on a ridge at or in front of and nearest the center of the divergence of the type lines. It can be an island, bifurcation, a dot or etc.
"
@export var detail_two_text: String = "			- in the picture below, D signifies the Delta of the pattern."
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 35)
