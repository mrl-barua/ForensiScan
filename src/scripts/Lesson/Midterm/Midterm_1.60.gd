...
@export var header_text: String = "Sub- secondary"
@export var detail_one_text: String = "- POINTS TO REMEMBER!"
@export var detail_two_text: String = "- this is intended only for Index,  Middle and Ring finger"
@export var detail_three_text: String = "		LOOPS- Ridge Counting"
@export var detail_four_text: String = "		WHORLS- Whorl Tracing"
@export var detail_five_text: String = "		ARCHES- Not included "
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 60)
