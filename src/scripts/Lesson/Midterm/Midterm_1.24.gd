...
@export var header_text: String = "For reference in actual use of the Materials, please watch the link:"
@export var detail_one_text: String = "https://www.youtube.com/watch?v=Q5jib9Zu-PI"
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 24)
