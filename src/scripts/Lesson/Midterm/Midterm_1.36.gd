...
@export var detail_one_text: String = "CORE- as the name implies, is the approximate center of the finger impression. It will be necessary to concern ourselves with the core of the loop type only."
@export var detail_two_text: String = "The core is placed upon or within the innermost sufficient recurve."
@export var detail_three_text: String = "- When the innermost sufficient recurve contains no ending ridge or rod rising as high as the shoulders of the loop, the core is placed on the shoulder of the loop farther from the delta."
@export var detail_four_text: String = "- When the innermost sufficient recurve contains an uneven number of rods rising as high as the shoulders, the core is placed upon the end of the center rod whether it touches the looping ridge or not."
@export var detail_five_text: String = "- When the innermost sufficient recurve contains an even number of rods rising as high as the shoulders, the core is placed upon the end of the farther one of the two center rods, the two center rods being treated as though they were connected by a recurving ridge.
or curves."
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 36)
