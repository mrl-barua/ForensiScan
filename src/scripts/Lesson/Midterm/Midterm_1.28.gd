...
@export var detail_one_text: String = "3. Enclosure- the point where  a ridge forks and then returns to a single parallel ridge, within a relatively short distance. 
"
@export var detail_two_text: String = "4. DOT-  a very short section of a ridge, usually round in contour, with probably only one pore.
"
@export var detail_three_text: String = "5. Short Ridge- a short ridge with considerable open area at either end."
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 28)
