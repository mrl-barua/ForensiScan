...
@export var header_text: String = "3 Division of Fingerprint patterns:"
@export var detail_one_text: String = "1. ARCH"
@export var detail_two_text: String = "Plain Arch- the ridges in the plain arch originate on one side of the pattern area and flow to the opposite side. This type of pattern contains no backward turn, recurves and deltas.
"
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 38)
