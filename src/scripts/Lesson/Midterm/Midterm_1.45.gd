...
@export var detail_one_text: String = "Answer: ULNAR Loop"
@export var detail_two_text: String = "because the slope down to the Left side. Also, the direction of the pattern is directing to the little finger."
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 45)
