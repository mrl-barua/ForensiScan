...
@export var detail_one_text: String = "3. Card Holder- this type of gadget is for clipping the fingerprint card to avoid movement of the card during printing."
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 15)
