...
@export var detail_one_text: String = "6. Fingerprint Powders- there are normally two kinds: the black and white or gray. These are applied on contrasting background.
"
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 18)
