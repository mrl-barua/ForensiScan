...
@export var header_text: String = "2. LOOP PATTERN"
@export var detail_one_text: String = "- The ridges in the core of the loop pattern make a backward turn arranging themselves in the form of a hairpin or staple. There is always one delta in all loop patterns."
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 40)
