...
@export var detail_one_text: String = "5. Magnifying Glass- used to examine developed latent prints; a 3-inch wide reading glass is useful.
"
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 17)
