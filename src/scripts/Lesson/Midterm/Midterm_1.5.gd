...
@export var header_text: String = "PROBLEM PRINTS:"
@export var detail_one_text: String = "- Mistakes. If a mistake is made, do not cross out the bad print and then re-roll the print on the back of the card. Instead, use a tab over and re-roll the print in the proper place on the front of the card.
"
@export var detail_two_text: String = "- Dry or soft skin. Certain people have dry and rough hands because of their occupations. Rubbing the tips of the fingers with oil or creams will often make the fingers pliable and soft enough for clear, unsmudged prints to be made. 
"
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 5)
