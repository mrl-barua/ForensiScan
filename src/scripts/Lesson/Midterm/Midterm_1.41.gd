...
@export var header_text: String = "2 Types of Loop Patterns:"
@export var detail_one_text: String = "1. ULNAR Loop- if a loop pattern slopes down to the Left in the left hand or slopes down to the right on the right hand it is ULNAR. "
@export var detail_two_text: String = "2. RADIAL Loop- if a loop pattern slopes down to the right on the left hand or slopes down to the left on the right hand it is RADIAL."
@export var detail_three_text: String = "The name of these two types originate from the two bones in the forearm."
@export var detail_four_text: String = "The radius bone is on the thumb side of the hand and the ulnar bone on the little finger,"
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 41)
