...
@export var detail_one_text: String = "Tented Arch- the ridges near the center of the print have an upward thrust arranging themselves as it were on both sides of a spine or axis. The pattern thus formed is reminiscent of a tent."
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 39)
