...
@export var detail_one_text: String = "Example 1: If all the fingerprints on your card appear with all whorl pattern you need to sum up all numerical values assigned to each fingers. "
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 53)
