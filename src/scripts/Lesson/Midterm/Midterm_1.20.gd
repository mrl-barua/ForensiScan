...
@export var header_text: String = "Items that may make up a Fingerprint Kit:"
@export var detail_one_text: String = "8. Fingerprint Lifting Tapes- There must be a sufficient supply of lifting tapes to be carried at all times"
@export var detail_two_text: String = "3 kinds of Lifting Tape:
"
@export var detail_three_text: String = "	1. Frosted"
@export var detail_four_text: String = "	2. Rubber"
@export var detail_five_text: String = "	3. Transparent"
