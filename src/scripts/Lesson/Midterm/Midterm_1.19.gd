...
@export var detail_one_text: String = "7. Fingerprint brushes- must be carried in pairs of three. Fiberglass brushes are preferably used by technicians. 
"
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 19)
