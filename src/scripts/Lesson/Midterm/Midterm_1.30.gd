...
@export var detail_one_text: String = "8. Crossover- a bridge is a short ridge that interconnects two other parallel ridges.
"
@export var detail_two_text: String = "9. Spur- a very short ridge, usually one to two pores, juts out from a free-flowing ridge.
"
...
func _ready():
	...
	ProgressManager.update_lesson_progress("midterm", 30)
