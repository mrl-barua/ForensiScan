...
@export var detail_one_text: String = "3. Where loops appeared in the thumb the following is used to translate"
@export var detail_two_text: String = "LEFT THUMB:				RIGHT THUMB:"
@export var detail_three_text: String = "1-11= SMALL (S)				1-17= SMALL (S)"
@export var detail_four_text: String = "12-16= MEDIUM (M)				18-22= MEDIUM (M)"
@export var detail_five_text: String = "17 more= LARGE				23 or more= LARGE"
@export var detail_six_text: String = ""
@export var detail_seven_text: String = "NOTE! RIGHT THUMB = (NUMERATOR)  LEFT THUMB= (DENOMINATOR)"
