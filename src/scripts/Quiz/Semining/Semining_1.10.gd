...
@export var detail_one_text: String = "1. Identify all loops pattern, from Right to Left."
@export var detail_two_text: String = "2. Start searching for loop patterns from the right thumb (finger #1) to the right ring (finger #4). If the right fingers are lacking, look for the same on prints from left thumb (finger #6) to left ring (finger #9)."
@export var detail_three_text: String = "3. The Key is always brought up above the classification line, regardless of the finger used."
@export var detail_four_text: String = "4. If there are no loops present there is no Key."
